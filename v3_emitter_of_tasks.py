...
def send_tasks(file_path: str, host: str, queue_name: str):
    """Send tasks from a CSV file to RabbitMQ"""            
    logs = read_tasks(file_path)
    for task in logs:
        send_message(host, queue_name, task)

# Standard Python idiom to indicate main program entry point
# This allows us to import this module and use its functions
# without executing the code below.n
...
#Created variable to easily change file name    
file_name = 'tasks.csv'

# send the message to the queue   
send_tasks(file_name, "localhost","task_queue2")
